...
$sql = "SELECT * FROM z_vhosts WHERE vh_acc_fk=" . $useraccount['ac_id_pk'] . " AND vh_deleted_ts IS NULL AND vh_type_in=2";
...
if ($quotainfo['qt_subdomains_in'] > GetQuotaUsages('subdomains', $useraccount['ac_id_pk'])) {
    echo "<br><h2>" . $lang['172'] . "</h2>";
    if ($totalexdomains > 0) {
        ?>
        <form id="frmNewSubDomain" name="frmNewSubDomain" method="post" action="runner.php?load=obj_vhosts">
            <table class="zform">
                <tr>
                    <th><?php echo $lang['173']; ?>:</th>
                    <td><input name="inSub" type="text" id="inSub" size="15" />
                        .
                        <select name="inAlt" id="inAlt">
                            <?php
                            do {
                ...
                <tr>
                    <th><?php echo $lang['162']; ?>:</th>
                    <td><input name="inAutoHome" type="checkbox" id="inAutoHome" value="1" />
        <?php echo $lang['164']; ?></td>
                ...
                <tr>
                    <th colspan="2" align="right"><input type="hidden" name="inReturn" value="<?php echo GetFullURL(); ?>" />
                        <input type="hidden" name="inAction" value="NewSubDomain" />
